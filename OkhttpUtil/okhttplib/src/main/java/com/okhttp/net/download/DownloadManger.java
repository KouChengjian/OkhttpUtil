...
public class DownloadManger {
     ...
     * @return
     */
    public DownloadManger start(Callback downloadCallback) {
     ...
     * @return
     */
    public DownloadManger start(DownLoad downloadData, Callback downloadCallback) {
        execute(downloadData, downloadCallback);
        return downloadManager;
    }
     ...
     * @param downloadCallback
     */
    public void setOnDownloadCallback(DownLoad downloadData, Callback downloadCallback) {
    ...
    public DownLoad getDbData(String url) {
        return CacheUtils.getInstance(context).getData(url);
    }
    ...
    public List<DownLoad> getAllDbData() {
        return CacheUtils.getInstance(context).getAllData();
    }
     ...
     * 执行下载任务
     */
    private void execute(DownLoad downloadData, Callback downloadCallback) {
        //防止同一个任务多次下载
